-- get_feed: ranked feed with follow boost + cursor pagination
-- Run this in the Supabase SQL Editor
-- v2: uses p_ref_time to freeze scores across paginated calls
...
as $$
  with scored as (
    select
      ...
      p.comment_count,
      p.created_at,
      -- Inline hot_score using frozen ref_time for pagination stability
