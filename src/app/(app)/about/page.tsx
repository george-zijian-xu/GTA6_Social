      ...
      <Section title="FAQs" id="faqs">
        <div className="space-y-6">
          ...
          <div>
            ...
            <p>But this site does not condone content that promotes, glorifies, threatens, or celebrates real-world violence, hate speech, or harm against real people. No seriously. The real world is falling apart already. Do not use this site to add to that and hurt people.</p>
