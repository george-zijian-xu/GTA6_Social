...
export const metadata: Metadata = {
  title: "DMCA Takedown",
  description: "Submit a DMCA takedown request for content on Leonida Social.",
  alternates: { canonical: "https://grandtheftauto6.com/dmca" },
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-10">
      ...
      <p className="text-foreground-muted mb-10 text-sm">
        Leonida Social respects intellectual property rights.
      </p>

      <div className="mb-8 p-4 rounded-xl bg-primary/5 border border-primary/10 text-sm text-primary">
        This DMCA page is a placeholder. Final legal copy and contact details will be provided
      ...
      <section className="mb-8">
        ...
        <div className="text-sm text-foreground-muted leading-relaxed space-y-3">
          <p>
            If you believe that content on Leonida Social infringes your copyright, you may submit a
      ...
      <section className="mb-8">
        ...
        <div className="text-sm text-foreground-muted leading-relaxed">
          <p>[DMCA contact email to be provided before launch]</p>
          <p className="mt-2">
            You can also use the report button on any post to flag content for immediate review.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="text-sm text-foreground-muted leading-relaxed space-y-2">
          <p>
            Leonida Social is a non-commercial fan community. GTA 6, Leonida, and related marks are
